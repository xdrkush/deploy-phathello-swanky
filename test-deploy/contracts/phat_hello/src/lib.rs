...
mod phat_hello {
    ...
    impl PhatHello {
        ...
        #[ink(constructor)]
        pub fn new(param: String, param2: String) -> Self {
            Self { demo_field: true, test: param, test2: param2 }
        }
    ...
    mod tests {
        ...
        fn it_works() {
            ...
            let phat_hello = PhatHello::new(String::from("Krashtest1"), String::from("Krashtest2"));
